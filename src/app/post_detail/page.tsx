		...
		<div class="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
			<div class="max-w-2xl">
				<div class="space-y-5 md:space-y-8">
					<div class="space-y-3">
						<h2 class="text-2xl font-bold md:text-3xl dark:text-white">My new 人権... I mean, instrument</h2>
					...
					<figure>
						<img class="w-full object-cover rounded-xl" src="/pos/IMG_7548.jpg" alt="試奏したShiresのQ30GR">
						</img>
						<figcaption class="mt-3 text-sm text-center text-gray-500">
						試奏したShiresのQ30GR
						</figcaption>
					</figure>
					<p class="text-lg text-gray-800 dark:text-gray-200">そこで、中古楽器でいいのがないか探してみる。メルカリで探してみると、T3Yが出品されていたので、
					...
					<figure>
						<img class="w-full object-cover rounded-xl" src="pos/IMG_7781.jpg" alt="T3Y">
						</img>
						<figcaption class="mt-3 text-sm text-center text-gray-500">
						T3Y、とてもきれい
						</figcaption>
